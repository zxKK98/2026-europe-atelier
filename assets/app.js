...
const days = [
  ...
  },
  {
    ...
    desc: "早班 OUIGO 高铁 9:31 从 Atocha Almudena Grandes 站厅出发，12:58 抵达 Barcelona Sants。下午在巴特罗之家入内，15:00 民宿 Check-in。傍晚留给第一晚安顿、晚餐和前往 Nou Barris 的路程；今晚只安排你收藏的 OBC 免费交响乐，完整听完 Borodin《波罗维茨舞曲》、Bartók《罗马尼亚民间舞曲》与 Tchaikovsky《天鹅湖》选段。",
    slots: [
      ...
      { t: "20:45", h: "OBC 交响乐团 · Mercè 广场免费音乐会", d: "巴塞罗那交响乐团暨加泰罗尼亚国家交响乐团（OBC）在 Plaça Major de Nou Barris 的年度免费公演。指挥 Miguel Sepúlveda，曲目：Borodin《波罗维茨舞曲》→ Bartók《罗马尼亚民间舞曲》→ Tchaikovsky《天鹅湖》选段。Auditori 官方页面标注约 120 分钟，免预约；按完整演出预留到 22:45 左右。", kind: "event", loc: {lat: 41.4490, lng: 2.1790}, hop: {via: "步行进场", dur: "20:40 前抵达"}, link: "https://www.auditori.cat/en/events/obc-merce-2026/", ticket: "免费 · 免预约 · 约 2h" },
      { t: "23:15", h: "Mercè Música · Bogatell 海滩音乐夜（可选）", d: "OBC 官方演出按约 2 小时预留到 22:45；如果听完还有体力，再从 Nou Barris 去 Bogatell，只把它当作海边夜场氛围，不再追 22:00 已开始的 Miki Núñez。9/25 ELS40 舞台目前公布 Aina Machuca、Miki Núñez、Sexenni、Buhos；市政府活动页列出 Miki 22:00-23:00、Buhos 01:15-02:45。免费，且从你家步行约 6 分钟。⚠ 这一项和 OBC 不属于同一条必做动线，累了直接回民宿。", kind: "event", loc: {lat: 41.39423, lng: 2.20488}, hop: {via: "Nou Barris → 地铁 → Poblenou → 步行", dur: "约 35-45min"}, link: "https://www.barcelona.cat/lamerce/en" }
    ],
  ...
  },
  {
    ...
    desc: "上午留给 Mercè 街头与哥特区，12:45 进入已购票的圣家堂。下午把原本与 OBC 冲突的 GYG Paella 体验移到这里：周六 Boqueria 市集正常开放，可保留市集采买、海鲜饭、Sangria 的完整环节。晚间主线更新为 Passeig de Gràcia 的 Correfoc（含新 Porta de l'Infern），看完直接去 Sips；Bogatell 海滩音乐是另一条可选线，不再和火魔游行硬串。",
    slots: [
      ...
      { t: "10:30", h: "Mercè 街头 · 哥特区 + Plaça de Sant Jaume", d: "Metro L4 Poblenou → Jaume I 约 15min，先在哥特区和 Plaça de Sant Jaume 感受节庆中心。2026 主宾城市是上海，官方介绍将有来自上海及巴塞罗那华人社群的 100+ 艺术家参与街头艺术、传统文化与音乐。具体游行/街头项目按官方 App 当日更新，不再把 gegants 写成固定时刻；全部免费，无需订票。", kind: "event", img: "assets/img/spots/merce-cavalcada.jpg", loc: {lat: 41.38260, lng: 2.17707}, hop: {via: "Metro L4 → Jaume I", dur: "15min · 2.5€"}, link: "https://www.lamerce.barcelona/en" },
