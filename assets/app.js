...
const days = [
  ...
  },
  {
    ...
    slots: [
      ...
      { t: "12:45", h: "圣家堂 · 已购票入内", d: "已购 12:45 场次。正值午间太阳穿透西侧受难立面彩窗，把内殿柱林染成一整片橙红——高迪毕生的『石头森林』最魔幻的时刻。留 2h30m 慢慢走。从 Casa Milà 打车 6min 或 Metro L5 Diagonal → Sagrada Família 15min。", kind: "museum", loc: {lat: 41.4036, lng: 2.1744}, img: "assets/img/spots/sagrada-familia.jpg", hop: {via: "打车/Metro L5", dur: "10min"}, link: "https://sagradafamilia.org/en/tickets-individuals", ticket: "Basilica 26€（已购）· 含塔 36€", notice: "9 月开放 09:00-20:00。已购 9/26 周六 12:45 场次。" },
